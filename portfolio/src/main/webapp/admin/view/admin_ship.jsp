...
<body>
    <form id="admin_reg" name="" method="post" action="./admin_join.do">
        <div class="membody">
           ...
           <div class="memoutline" >
             ...
             <div class="memsel2">
                <ul>
                    ...
                    <li><button class="idcheck" onclick="idck(event);">중복체크</button></li>
                </ul>    
              </div>
              <div class="memsel2">
                <ul>
                    <li class="memfont">패스워드</li>
                    <li><input type="password" class="admamber1" id="" name="apw" value="" placeholder="패스워드를 입력해 주세요"></li>
              ...
              <div class="memsel4">
                <ul>
                    ...
                    <li>
                        <select class="adnumber" name="atel1" id="">
                            <option value="010">010</option>
                            <option value="011">011</option>
                        </select>
                    </li>
                    <li class="ad_number">-</li>
                    <li><input type="text" class="adnumber" id="" name="atel2" onkeyup="tell_value();" maxlength="4"></li>
                    <li class="ad_number">-</li>
                    <li><input type="text" class="adnumber" id="" name="atel3" onkeyup="tell_value();" maxlength="4"></li>
                    <li><input type="hidden" name="atel" value=""></li>
                </ul>    
              </div> 
       ...
       <div class="admembt">
         <ul>
           <li><button type="button" class="admembt_ok" id="adm_ok" onclick="regit();">신청하기</button></li>
           <li><button type="button" class="admembt_no" id="adm_cancel" onclick="goBack();">취소하기</button></li>
        </ul>
       </div>
    </form> 
</body>
<script src="../js/adm_btn.js?v=<%=dates%>"></script>
<script src="../js/admin_ship.js?v=<%=dates%>"></script>
</html>